...
|-----------|-----|----------------------------|
| **Dashboard** (Stats + Status tabs) | [`documents/FunctionDescription/Dashboard.md`](documents/FunctionDescription/Dashboard.md) | `apps/web/src/pages/home/` (`index.tsx` tabs, `OrderStatsTab.tsx`, `OrderStatusTab.tsx`, `status/*.tsx`), `apps/api/src/modules/order/order.service.ts` → `getDashboard()` + `getStatusOverview()`, `packages/shared/dtos/production-order.dto.ts`, `packages/shared/dtos/order-status.dto.ts` |
...
| **Orders** (List + Workshop + Import) | [`documents/FunctionDescription/Orders.md`](documents/FunctionDescription/Orders.md) | `apps/web/src/pages/orders/` (`index.tsx`, `ListOrderTab.tsx`, `OrderTableWorkshop.tsx`, `ImportOrderTab.tsx`), `apps/web/src/components/orders/cells/`, `apps/web/src/components/orders/BulkEditToolbar.tsx`, `apps/api/src/modules/order/` (trừ `getDashboard`), `packages/shared/dtos/production-order.dto.ts` (trừ Dashboard zods), `apps/api/src/utils/transform-drive-url.ts` (chia sẻ với Image module) |
| **Auth & Identity** | [`documents/FunctionDescription/Auth.md`](documents/FunctionDescription/Auth.md) | `apps/web/src/pages/login/`, `apps/web/src/pages/register/`, `apps/web/src/pages/account/`, `apps/web/src/pages/users/`, `apps/web/src/pages/roles/`, `apps/web/src/pages/custom-roles/`, `apps/web/src/pages/departments/`, `apps/web/src/store/authStore.ts`, `apps/web/src/hooks/usePermission.ts`, `apps/web/src/components/roles/PermissionMatrix.tsx`, `apps/web/src/components/sidebar/Sidebar.tsx` (dynamic filter), `apps/api/src/modules/auth/`, `user/`, `role/`, `custom-role/`, `permission/`, `departments/`, `packages/shared/constants/permission-catalog.ts` |
...
| **Workshop Config** (danh mục xưởng) | [`documents/FunctionDescription/WorkshopConfig.md`](documents/FunctionDescription/WorkshopConfig.md) | `apps/web/src/pages/workshop-config/`, `apps/web/src/store/workshopConfigStore.ts`, `apps/web/src/services/workshopConfig.ts`, `apps/api/src/modules/workshop-config/`, `packages/shared/dtos/workshop-config.dto.ts`, `packages/shared/enums/workshop-config-category.ts` |
