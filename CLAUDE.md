...
| **Products** (Config + Xưởng + **Chi tiết sản phẩm/catalog + Biến thể** — Products.md §2.4/§2.5: `productCategoryId` (ref `ProductCategory` module riêng, §4)/`printMethod`/`printArea`/`mockupPrintUrl`/`sizeChartUrl`/`description`/`itemSpecifics`/đóng gói mặc định + `variations[]` (SKU unique toàn hệ thống, `cost`/`nonShipCost`/`retailPrice`)) | [`documents/FunctionDescription/Products.md`](documents/FunctionDescription/Products.md)                         | `apps/web/src/pages/products/`, `apps/api/src/modules/product-config/`, `apps/api/src/modules/factory/`, `apps/api/src/modules/machine-type/`, `apps/api/src/modules/product-category/` (§4), shared DTOs `product-config.dto.ts`, `factory.dto.ts`, `machine-type.dto.ts`, `product-category.dto.ts`, workshop_config category `print_method` (`WorkshopConfig.md`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
