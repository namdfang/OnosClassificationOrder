...
const PRODUCT_TYPE_CODE_MAP: Record<string, string> = {
    ...
    "all-over print basketball v-neck mesh shirt": "TTOPLUOICOTIM",
    ...
    "[pant] all-over print kid and youth satin pajama set": "LPJMSETKID",
    "[shirt] all-over print kid and youth satin pajama set": "LPJMSETKID",
