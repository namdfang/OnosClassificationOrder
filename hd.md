...
mongorestore --uri="mongodb://localhost:27017/?directConnection=true" --archive=./onos-20260628.archive --gzip --drop --nsFrom='onosfactory-prod._' --nsTo='onos-classifycation._'
